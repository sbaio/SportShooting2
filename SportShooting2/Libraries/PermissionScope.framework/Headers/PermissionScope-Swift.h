...
@property (nonatomic, copy) void (^ _Nullable onAuthChange)(BOOL finished, NSArray<PermissionResult *> * _Nonnull results);

/// Callback called when the user taps on the close button.
@property (nonatomic, copy) void (^ _Nullable onCancel)(NSArray<PermissionResult *> * _Nonnull results);

/// Called when the user has disabled or denied access to notifications, and we're presenting them with a help dialog.
@property (nonatomic, copy) void (^ _Nullable onDisabledOrDenied)(NSArray<PermissionResult *> * _Nonnull results);
...
- (void)show:(void (^ _Nullable)(BOOL finished, NSArray<PermissionResult *> * _Nonnull results))authChange cancelled:(void (^ _Nullable)(NSArray<PermissionResult *> * _Nonnull results))cancelled;
